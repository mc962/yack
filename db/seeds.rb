...
Chatroom.new(room_title: 'languages', room_type: 'general', purpose: 'Languages of the world').save!
Chatroom.new(room_title: 'travel', room_type: 'general', purpose: 'Travel the world over').save!
Chatroom.new(room_title: 'food', room_type: 'general', purpose: 'Tasty eats').save!
