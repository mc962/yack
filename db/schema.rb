...
ActiveRecord::Schema.define(version: 20170428213823) do
  ...
  create_table "emoticons", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["message_id"], name: "index_emoticons_on_message_id", using: :btree
    t.index ["user_id"], name: "index_emoticons_on_user_id", using: :btree
  end
